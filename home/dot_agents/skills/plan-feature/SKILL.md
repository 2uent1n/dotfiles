...
6. A first concise plan draft goes in-chat, with the open questions. Once I am explicitly satisfied, write the complete plan to a `.md` in the `.scratch/` folder: steps, files, decisions with their rationale, options considered and rejected.
